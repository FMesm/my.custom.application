		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#umgmycustomapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"umgmycustomapplication-display": {
								"semanticObject": "umgmycustomapplication",
								"action": "display",
								"description": "A custom application to consume library",
								"title": "Custom application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=umg.my.custom.application",
									"url": sap.ui.require.toUrl("umg/my/custom/application")
								}
							}
						}
					}
